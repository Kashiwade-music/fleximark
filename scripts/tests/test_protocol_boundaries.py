...
INVALID_FIXTURE = ROOT / "test" / "fixtures" / "protocol-v5-invalid.json"
RENDER_NAVIGATION_FIXTURE = (
    ROOT / "test" / "fixtures" / "protocol-v5-render-navigation.json"
)
OPTIONAL_PRESENT_FIXTURE = (
    ROOT / "test" / "fixtures" / "protocol-v5-optional-present.json"
)
...
class ProtocolBoundaryTests(unittest.TestCase):
    ...
    def test_nested_and_envelope_boundary_fixture_is_rejected(self) -> None:
        self.assertEqual(self.fixture["schemaVersion"], 5)
    ...
    def test_rust_selection_wire_matches_render_navigation_schema(self) -> None:
        ...
        self.assertEqual(self.render_navigation_fixture["schemaVersion"], 5)
    ...
    def test_valid_optional_present_dtos_remain_accepted(self) -> None:
        self.assertEqual(self.optional_present_fixture["schemaVersion"], 5)
